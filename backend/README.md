...
## Project Structure
    ...
    ├── testmultimodule_dev_94779  # Django project configurations
...
1. Clone this repo and `cd testmultimodule_dev_94779`
...
2. Clone this repo and `cd testmultimodule_dev_94779`
